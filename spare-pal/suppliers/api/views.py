from django.shor.serializerstcuts import get_object_or_404, render
...
from  import SupplierSerializer, CompanyDetailAddressSerializer, CompanyManagerDetailSerializer
