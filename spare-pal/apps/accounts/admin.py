...
class CustomUserAdmin(UserAdmin):
    ...
    list_display = ('email', 'first_name', 'last_name', 'is_supplier', 'is_active', 'date_joined')
    ...
    fieldsets = (
        ...
        (_('Permissions'), {'fields': ('is_active', 'is_staff', 'is_supplier', 'groups', 'user_permissions')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'password1', 'password2', 'is_supplier', 'is_active', 'is_staff'),
        }),
    )
