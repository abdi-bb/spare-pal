...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        permissions = Permission.objects.filter(
            ...
            codename__in=['view_company', 'add_company', 'change_company', 'delete_company']
        )

        # Assign permissions to the Supplier group
        supplier_group.permissions.set(permissions)

        self.stdout.write(self.style.SUCCESS('Supplier group and CRUD permissions for Company created successfully'))
